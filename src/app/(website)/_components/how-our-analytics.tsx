        ...
        <div className='py-6 md:py-10 lg:py-16 bg_color'>
            <div className="container grid grid-cols-1 md:grid-cols-5 gap-6 md:gap-10 lg:gap-20">
                <div className='md:col-span-2'>
                    <Image src="/assets/images/how_our_analytic.jpeg" alt="how our analytics" width={1000} height={1000} className='w-[622px] h-[360px] md:h-[500px] xl:h-[580px] object-fill rounded-[16px]' />
                </div>
