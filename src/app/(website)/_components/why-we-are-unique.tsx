        ...
        <div className='bg-white py-6 md:py-10 lg:py-16'>
            <div className='container '>
                ...
                <div className='grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 py-6 md:py-10 lg:py-12'>
                    ...
                    <div className='md:col-span-1 flex flex-col items-center rounded-[16px] p-4 border border-[#B6B6B6)] group bg-transparent transition'>
                        <div className='flex flex-col items-start'>
                            <div className='bg-[#E6F4E6] rounded-[8px] p-5 inline-flex mb-2 md:mb-1' >

                                <Database className='text-primary' />
                            </div>
                            <h4 className='text-sm lg:text-base font-normal text-[#131313] group-hover:text-[#131313] leading-normal py-4'>Access verified performance data</h4>
                            <p className='text-sm font-normal text-[#131313] group-hover:text-[#131313] leading-[150%]'>Every stat, every match, every achievement verified and recorded in one place. No more scattered records or lost history. </p>
                        </div>
                    </div>
                    <div className='md:col-span-1 flex flex-col items-center rounded-[16px] p-4 border border-[#B6B6B6)] group bg-green-700 transition'>
                        <div className='flex flex-col items-start'>
                            ...
                            <h4 className='text-sm lg:text-base font-normal  text-[#131313] group-hover:text-[#131313] leading-normal py-4'>Receive objective ratings</h4>
                            <p className='text-sm font-normal text-[#131313] group-hover:text-[#131313] leading-[150%]'>Get rated based on real performance metrics, not opinions. Fair, transparent, and comparable across regions</p>
                        </div>
                    </div>
                    <div className='md:col-span-1 flex flex-col items-center rounded-[16px] p-4 border border-[#B6B6B6)] group bg-transparent transition'>
                        <div className='flex flex-col items-start'>
                            ...
                            <h4 className='text-sm lg:text-base font-normal text-[#131313] group-hover:text-[#131313] leading-normal py-4'>Track your career progression and transfer history</h4>
                            <p className='text-sm font-normal text-[#131313] group-hover:text-[#131313] leading-[150%]'>Track your entire football journey. Every club, every season, every progression milestone documented.</p>
                        </div>
                    </div>
                ...
                <div className="pb-6 md:py-6 md:pl-6 shadow-[0px_4px_16px_0px_#00000029] rounded-[16px]  grid grid-cols-1 md:grid-cols-5 gap-8 md:gap-9 lg:gap-10 ">
                    ...
                    <div className='md:col-span-3 h-full flex flex-col justify-center px-4 md:pr-6'>
                        ...
                        <p className='text-base md:text-lg text-[#131313] leading-[120%] font-normal py-2 md:py-3'>Key Advantages</p>
                        <ul>
