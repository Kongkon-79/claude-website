...
const WhatDoWeOffer = () => {
    return (
        <div className='py-6 md:py-12 lg:py-16'>
            ...
            <div className='container grid grid-cols-1 md:grid-cols-2 gap-6 md:gap-20 lg:gap-32 xl:gap-48'>
                <div className="order-2 md:order-1 md:col-span-1 flex items-center">
                    <div className=' bg_color shadow-[0px_4px_16px_0px_#00000029] rounded-[16px] flex flex-col justify-center py-6 md:py-10 lg:py-14 px-6 md:px-10 xl:px-14'>
                ...
                <div className='order-1 md:order-2 md:col-span-1 w-full flex items-center justify-end'>
                    <Image src="/assets/images/what_do_we_offers.png" alt="What Do We Offer" width={1000} height={1000} className='w-[466px] h-[360px] md:h-[480px] xl:h-[540px] object-concatin rounded-[16px]' />
                </div>
            </div>
        </div>
    )
