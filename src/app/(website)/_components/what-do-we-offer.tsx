        ...
        <div className='py-6 md:py-12 lg:py-16'>
            ...
            <div className='container grid grid-cols-1 md:grid-cols-2 gap-6 md:gap-20 lg:gap-32 xl:gap-48'>
                ...
                <div className='order-1 md:order-2 md:col-span-1'>
                    <Image src="/assets/images/what_do_we_offers.png" alt="What Do We Offer" width={1000} height={1000} className='w-full h-[360px] md:h-[480px] xl:h-[600px] object-concatin rounded-[16px]' />
                </div>
            </div>
        </div>
    )
