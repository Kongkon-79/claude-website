  ...
  return (
    <div className="relative max-w-[1400px] mx-auto w-full bg-[url('/assets/images/home_page/sm_bg.svg')] md:bg-[url('/assets/images/home_page/lg_bg.svg')] bg-cover bg-center bg-no-repeat min-h-[650px] md:h-[850px] py-10 md:py-16 lg:py-20 rounded-[30px] md:rounded-[50px] mt-6 md:mt-8 lg:mt-10 xl:mt-12 overflow-hidden flex flex-col justify-center">
      <div className="relative z-10 px-4 md:px-8 lg:px-12 flex flex-col items-center w-full max-w-[1080px] mx-auto">
        ...
        <div className="grid grid-cols-2 lg:grid-cols-4 gap-4 md:gap-5 w-full max-w-[1200px] mb-10 md:mb-16">
          {missionData?.map((item) => {
            return (
              <div
                key={item?.id}
                className="bg-transparent border-[2px] md:border-[3px] border-primary rounded-[25px] md:rounded-[40px] p-3 md:p-3 flex flex-col items-center justify-between h-full hover:shadow-[0_0_20px_rgba(16,230,7,0.2)] transition-all duration-300"
              >
                ...
                <div className="text-center flex flex-col gap-3 md:gap-5">
                  ...
                  <span className="text-primary text-xl md:text-3xl lg:text-4xl  font-bold">
                    {item?.step}
                  </span>
                </div>
              </div>
        ...
        <div className="w-full flex justify-center md:justify-start max-w-[1200px]">
          <Link
            ...
            className="h-10 md:h-14 inline-flex items-center justify-center rounded-full bg-primary px-8 md:px-12 text-sm md:text-lg  font-bold text-black transition-all hover:opacity-90 hover:scale-105 shadow-[0_0_15px_rgba(16,230,7,0.4)]"
          >
            Get Your Report
          </Link>
        </div>
