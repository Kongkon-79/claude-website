...
const StopGuessing = () => {
  return (
    <div className="relative max-w-[1400px] mx-auto w-[95%] md:w-full bg-[url('/assets/images/pep/sm_stop_buessing.svg')] md:bg-[url('/assets/images/pep/lg_stop_buessing.svg')] bg-cover bg-center bg-no-repeat min-h-[500px] md:h-[750px] py-10 md:py-16 lg:py-20 rounded-[30px] md:rounded-[70px] mt-6 md:mt-8 lg:mt-10 xl:mt-12 overflow-hidden flex flex-col justify-center items-center text-center">
